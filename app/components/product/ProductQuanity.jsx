...
const ProductQuantity = ({
  ...
  return (
    <div className="flex gap-4 md:gap-[18px] xl:gap-10 w-full flex-wrap">
      {isShowQuantity && (
        <div
          className={`inline-flex h-12 max-w-[104px] min-w-[104px] items-center gap-3 text-black font-montserrat font-medium tracking-[-0.6px] 
        rounded-[5px] ${!isLoading && "border border-[#e5e7eb]"}`}
        >
          {isLoading ? (
